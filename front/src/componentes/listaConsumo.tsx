...
export default class ListaConsumo extends Component<props, state> {
    ...
    renderCamposPesquisa() {
        ...
        return (
            <>
                <div className="row container striped">
    ...
    renderBotaoAdicionar() {
        ...
        return (
            <>
                <button onClick={(e) => this.props.seletorView('Novo Consumo', e)} className={estiloBotaoNovo} style={{ margin: "200px" }} type="submit" name="action">Novo
